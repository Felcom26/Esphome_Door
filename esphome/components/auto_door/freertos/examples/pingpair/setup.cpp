...
void setup(void) {
  ...
  xTaskCreate(vRadioSoftIrqTask, (const signed char *) PSTR("RA"), configMINIMAL_STACK_SIZE, NULL, tskIDLE_PRIORITY + 3,
              NULL);
  xTaskCreate(vReceiverTask, (const signed char *) PSTR("RC"), configMINIMAL_STACK_SIZE, NULL, tskIDLE_PRIORITY + 2,
              NULL);
  xTaskCreate(vSenderTask, (const signed char *) PSTR("SE"), configMINIMAL_STACK_SIZE, NULL, tskIDLE_PRIORITY + 2,
              NULL);
  xTaskCreate(vStatusTask, (const signed char *) PSTR("ST"), configMINIMAL_STACK_SIZE, NULL, tskIDLE_PRIORITY + 1,
              NULL);
  xTaskCreate(vInputTask, (const signed char *) PSTR("IN"), configMINIMAL_STACK_SIZE, NULL, tskIDLE_PRIORITY + 1, NULL);
