...
#define vSemaphoreCreateBinary(xSemaphore) \
  { \
    (xSemaphore) = xQueueGenericCreate((unsigned portBASE_TYPE) 1, semSEMAPHORE_QUEUE_ITEM_LENGTH, \
...
#define xSemaphoreGive(xSemaphore) \
  xQueueGenericSend((xQueueHandle) (xSemaphore), NULL, semGIVE_BLOCK_TIME, queueSEND_TO_BACK)
...
#define xSemaphoreAltGive(xSemaphore) \
  xQueueAltGenericSend((xQueueHandle) (xSemaphore), NULL, semGIVE_BLOCK_TIME, queueSEND_TO_BACK)
...
/**
 * semphr. h
 * <pre>xSemaphoreHandle xSemaphoreCreateCounting( unsigned portBASE_TYPE uxMaxCount, unsigned portBASE_TYPE
 uxInitialCount )</pre>
 *
