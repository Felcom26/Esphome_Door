...
#define SOC_CLK_RC_FAST_D256_FREQ_APPROX \
  (SOC_CLK_RC_FAST_FREQ_APPROX / 256)     /*!< Approximate RC_FAST_D256_CLK frequency in Hz */
...
typedef enum {
  ...
  SOC_CPU_CLK_SRC_PLL = 1,     /*!< Select PLL_CLK as CPU_CLK source (PLL_CLK is the output of 40MHz crystal oscillator
                                  frequency multiplier, can be 480MHz or 320MHz) */
...
typedef enum {
  ...
  SOC_RTC_SLOW_CLK_SRC_RC_FAST_D256 = 2, /*!< Select RC_FAST_D256_CLK (referred as FOSC_DIV or 8m_d256/8md256 in TRM and
                                            reg. description) as RTC_SLOW_CLK source */
...
typedef enum {
  ...
  SOC_RTC_FAST_CLK_SRC_DEFAULT =
      SOC_RTC_FAST_CLK_SRC_XTAL_D2, /*!< XTAL_D2_CLK is the default clock source for RTC_FAST_CLK */

  SOC_RTC_FAST_CLK_SRC_XTAL_DIV __attribute__((deprecated)) =
      SOC_RTC_FAST_CLK_SRC_XTAL_D2, /*!< Alias name for `SOC_RTC_FAST_CLK_SRC_XTAL_D2` */
...
typedef enum {
  ...
  SOC_MOD_CLK_RTC_FAST, /*!< RTC_FAST_CLK can be sourced from XTAL_D2 or RC_FAST by configuring soc_rtc_fast_clk_src_t
                         */
  SOC_MOD_CLK_RTC_SLOW, /*!< RTC_SLOW_CLK can be sourced from RC_SLOW, XTAL32K, or RC_FAST_D256 by configuring
                           soc_rtc_slow_clk_src_t */
  ...
  SOC_MOD_CLK_XTAL32K, /*!< XTAL32K_CLK comes from the external 32kHz crystal, passing a clock gating to the peripherals
                        */
  SOC_MOD_CLK_RC_FAST, /*!< RC_FAST_CLK comes from the internal 20MHz rc oscillator, passing a clock gating to the
                          peripherals */
  SOC_MOD_CLK_RC_FAST_D256, /*!< RC_FAST_D256_CLK comes from the internal 20MHz rc oscillator, divided by 256, and
                               passing a clock gating to the peripherals */
 ...
 * @endcode
 */
#define SOC_GPTIMER_CLKS \
  { SOC_MOD_CLK_APB, SOC_MOD_CLK_XTAL }
 ...
 */
#define SOC_RMT_CLKS \
  { SOC_MOD_CLK_APB, SOC_MOD_CLK_RC_FAST, SOC_MOD_CLK_XTAL }
 ...
 */
#define SOC_TEMP_SENSOR_CLKS \
  { SOC_MOD_CLK_XTAL, SOC_MOD_CLK_RC_FAST }
 ...
 */
#define SOC_UART_CLKS \
  { SOC_MOD_CLK_APB, SOC_MOD_CLK_XTAL, SOC_MOD_CLK_RC_FAST }
 ...
 */
#define SOC_I2S_CLKS \
  { SOC_MOD_CLK_PLL_F160M, SOC_MOD_CLK_XTAL, I2S_CLK_SRC_EXTERNAL }
 ...
 */
#define SOC_SPI_CLKS \
  { SOC_MOD_CLK_XTAL, SOC_MOD_CLK_APB }
 ...
 */
#define SOC_LEDC_CLKS \
  { SOC_MOD_CLK_XTAL, SOC_MOD_CLK_APB, SOC_MOD_CLK_RC_FAST }

/**
 * @brief Type of LEDC clock source, reserved for the legacy LEDC driver
 */
typedef enum {
  LEDC_AUTO_CLK = 0, /*!< LEDC source clock will be automatically selected based on the giving resolution and duty
                        parameter when init the timer*/
  ...
  LEDC_USE_RTC8M_CLK __attribute__((deprecated("please use 'LEDC_USE_RC_FAST_CLK' instead"))) =
      LEDC_USE_RC_FAST_CLK, /*!< Alias of 'LEDC_USE_RC_FAST_CLK' */
